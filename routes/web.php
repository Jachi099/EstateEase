...
Route::get('/landlord/profile/edit', [LandlordController::class, 'editProfile'])->name('landlord.profile_edit');
Route::post('/landlord/profile/update', [LandlordController::class, 'updateProfile'])->name('landlord.update_profile');
Route::post('/landlord/profile/delete', [LandlordController::class, 'deleteProfile'])->name('landlord.delete_profile');
