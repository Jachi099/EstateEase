    ...
    <button type="submit" style="border: none; background: transparent;">
        ...
        @endif
                    ...
                    <div class="flex-col-3 flex-col-7">
                        ...
                        <input type="text" class="name_txtbox" name="full_name" id="full_name" value="{{ old('full_name', $landlord->full_name) }}" />
                      ...
                      <input type="text" class="phn_txtbox" name="phone_number" id="phone_number" value="{{ old('phone_number', $landlord->phone_number) }}" />
