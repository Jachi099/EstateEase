...
<html>
  <head>
    ...
    <link rel="stylesheet" href="{{asset('sevice_admin_css/serviceu95provideru95admin.css')}}">
        ...
        <div class="flex-col flex">
          <div class="flex-row flex">
            <div class="flex-col-1 flex-col-4">
              ...
              <a href="addu95serviceu95provideru95admin.html"
          ...
          <div class="flex-col-3 flex-col-4">
            ...
            <div class="overlap-group1">
              <div class="servicepro_heading"></div>
            </div>
          </div>
        </div>
      </div>
