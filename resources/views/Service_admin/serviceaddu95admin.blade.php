...
<html>
  <head>
    ...
    <link rel="stylesheet" href="{{asset('sevice_admin_css/serviceaddu95admin.css')}}">
        ...
        <div class="flex-col flex">
          ...
          <div class="flex-row-1 flex-row-3">
            ...
            <div class="flex-col-1 flex-col-3 montserrat-medium-black-16px">
              ...
              <div class="servicetype_txt"></div>
              <div class="details">DETAILS</div>
              <div class="details_txtbox"></div>
            </div>
          </div>
          <div class="flex-col-2 flex-col-3">
            <div class="flex-row-2 flex-row-3">
              <div class="add-picture add montserrat-medium-black-16px">ADD PICTURE</div>
            ...
            <div class="overlap-group-container">
              ...
              <div class="back-container">
                <a href="serviceu95admin.html"> <div class="goback_btn"></div></a>
