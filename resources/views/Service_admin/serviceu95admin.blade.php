...
<html>
  <head>
    ...
    <link rel="stylesheet" href="{{asset('sevice_admin_css/serviceu95admin.css')}}">
          ...
          <div class="flex-row flex">
            <div class="flex-col-1 flex-col-3">
              ...
              <div class="service-container">
                <a href="serviceaddu95admin.html"><div class="add-services">ADD SERVICES</div> </a
                ><a href="servicerequ95admin.html"><div class="check-service-requests">CHECK SERVICE REQUESTS</div> </a>
              </div>
